...
var Finder = function Finder (query, collection, model_type) {
...
(function () {
  ...
  this.all = function all (callback) {
    ...
    if (this.fn_query) {
      ...
      Finder.db.getCollectionFromQuery(this.query,
          'index:' + this.model.type, this.model.type, null, null, fn);
    } else {
  ...
  this.some = function some (start, end, callback) {
    ...
    if (this.fn_query) {
      ...
      Finder.db.getCollectionFromQuery(this.query,
          'index:' + this.model.type, this.model.type, start, end, fn);
    } else {
      callback(null, new Collection());
    }
